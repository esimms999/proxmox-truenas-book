...
- Get the ISO from the [TrueNAS download page](https://www.truenas.com/download-truenas-scale/). As of this writing, **25.10 "Goldeye"** is the current stable line (25.10.7 at the time of writing) — pick that, not the TrueNAS 26 beta and not Nightlies, unless you specifically need a newer feature and accept the risk.
